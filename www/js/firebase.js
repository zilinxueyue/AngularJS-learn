...
(function () {
        ...
        switch (typeof b) {
            ...
            case "object":
                ...
                for (f in b)Object.prototype.hasOwnProperty.call(b, f) && (e = b[f], "function" != typeof e && (c.push(d),
                    na(f, c), c.push(":"), ma(a, a.mc ? a.mc.call(b, f, e) : e, c), d = ","));
                c.push("}");
                break;
            case "function":
                break;
    ...
    D.prototype.Wd = function (a, b) {
        ...
        Fa("Query.once", a, !1);
        z("Query.once", 2, b, !1);
        var d = Ia("Query.once", arguments[2], arguments[3]), e = this, f = !0;
    ...
    function Ia(a, b, c) {
        var d = {};
        if (b && c)d.cancel = b, z(a, 3, d.cancel, !0), d.Y = c, ua(a, 4, d.Y); else if (b)if ("object" === typeof b && null !== b)d.Y = b; else if ("function" === typeof b)d.cancel = b; else throw Error(sa.je(a, 3, !0) + "must either be a cancel callback or a context object.");
        return d
    };
    function F(a, b) {
    ...
    h.G = function (a) {
        ...
        if (a instanceof F)for (c = a.da; c < a.n.length; c++)b.push(a.n[c]); else for (a = a.split("/"), c = 0; c < a.length; c++)0 < a[c].length && b.push(a[c]);
        return new F(b, 0)
    };
    h.f = function () {
    ...
    function Qa(a) {
        if (null !== a.Eb) {
            var b = a.Eb, c = a.Fa, d = a.f(), e = A(b.B.children, c);
    ...
    h.remove = function (a, b) {
        var c, d;
        c = this;
        if (0 > b(a, c.key))c.left.f() || c.left.Q() || c.left.left.Q() || (c = eb(c)), c = c.J(null, null, null, c.left.remove(a, b), null); else {
            c.left.Q() && (c = fb(c));
    ...
    function sb(a, b, c) {
        ...
        b = a.C[0];
        c = a.C[1];
        for (var g = a.C[2], k = a.C[3], l = a.C[4], m, e = 0; 80 > e; e++)40 > e ? 20 > e ? (f = k ^ c & (g ^ k), m = 1518500249) : (f = c ^ g ^ k, m = 1859775393) : 60 > e ? (f = c & g | k & (c | g), m = 2400959708) : (f = c ^ g ^ k, m = 3395469782), f = (b <<
    ...
    rb.prototype.update = function (a, b) {
        ...
        for (var c = b - this.qa, d = 0, e = this.xc, f = this.$a; d < b;) {
            ...
            } else for (; d < b;)if (e[f] = a[d], ++f, ++d, f == this.qa) {
                sb(this, e);
                f = 0;
                break
            }
    ...
    var Db = Cb("Opera") || Cb("OPR"), Eb = Cb("Trident") || Cb("MSIE"), Fb = Cb("Gecko") && -1 == zb.toLowerCase().indexOf("webkit") && !(Cb("Trident") || Cb("MSIE")), Gb = -1 != zb.toLowerCase().indexOf("webkit");
    (function () {
        var a = "", b;
    ...
    function Jb(a, b) {
        ...
        for (var c = b ? Ib : Hb, d = [], e = 0; e < a.length; e += 3) {
            var f = a[e], g = e + 1 < a.length, k = g ? a[e + 1] : 0, l = e + 2 < a.length, m = l ? a[e + 2] : 0, p = f >> 2, f = (f & 3) << 4 | k >> 4, k = (k & 15) << 2 | m >> 6, m = m & 63;
            l || (m = 64, g || (k = 64));
    ...
    function Mb(a) {
        for (var b = "", c = 0; c < arguments.length; c++)b = ea(arguments[c]) ? b + Mb.apply(null, arguments[c]) : "object" === typeof arguments[c] ? b + u(arguments[c]) : b + arguments[c], b += " ";
        return b
    }
    ...
    function Zb(a, b) {
        if ("array" == da(a))for (var c = 0; c < a.length; ++c)b(c, a[c]); else $b(a, b)
    }
    ...
    h.hash = function () {
        ...
        var b = typeof this.F, a = a + (b + ":"), a = "number" === b ? a + bc(this.F) : a + this.F;
        return Lb(a)
    };
    h.j = function () {
        return this.F
    ...
    function lc(a, b, c) {
        N.call(this, a, c);
        null === b && (b = new Ta(ic), a.Da(function (a, c) {
    ...
    h = lc.prototype;
    h.H = function (a, b) {
        var c = this.O(a), d = this.o, e = this.xa;
    ...
    function nc(a, b, c) {
        ...
        var f = function (e) {
                function f(e, g) {
                    var k = p - e, t = p;
                    p -= e;
                    var s = a[k].name, k = new Za(c ? a[k] : s, b[s], g, null, d(k + 1, t));
                    l ? l.left = k : m = k;
                    l = k
                }

                for (var l = null, m = null, p = a.length, t = 0; t < e.count; ++t) {
                    var s = qc(e), w = Math.pow(2, e.count - (t + 1));
                    s ? f(w, !1) : (f(w, !1), f(w, !0))
                }
                return m
            }(new pc(a.length)),
    ...
    rc.prototype.yb = function (a, b, c) {
        sc(this, a);
        a = this.wb[a] || [];
        for (var d = 0; d < a.length; d++)if (a[d].ba === b && (!c || c === a[d].Y)) {
            a.splice(d, 1);
            break
        }
    };
    ...
    Q.prototype.open = function (a, b) {
        ...
        this.W.onmessage = function (a) {
            if (null !== c.W)if (a = a.data, yc(c.aa, "bytes_received", a.length), Hc(c), null !== c.frames)Ic(c, a); else {
                a:{
    ...
    Nc.prototype.open = function (a, b) {
        ...
        Tb(function () {
            if (!c.Ma) {
                c.ma = new Qc(function (a, b, d, k, l) {
                    yc(c.aa, "bytes_received", u(arguments).length);
                    if (c.ma)if (c.Ja && (clearTimeout(c.Ja), c.Ja = null), c.pb = !0, "start" == a)c.id = b, c.rd = d; else if ("close" === a)b ? (c.ma.oc = !1, Kc(c.od, b, function () {
                        c.Oa()
                    })) : c.Oa(); else throw Error("Unrecognized command received: " + a);
                }, function (a,
                             b) {
                    yc(c.aa, "bytes_received", u(arguments).length);
                    Lc(c.od, a, b)
    ...
    Nc.isAvailable = function () {
        return !Pc && !("object" === typeof window && window.chrome && window.chrome.extension && !/^chrome/.test(window.location.href)) && !("object" === typeof Windows && "object" === typeof Windows.he) && (Oc || !0)
    };
    h = Nc.prototype;
    h.Lc = function () {
    };
    ...
    function Sc(a) {
        if (a.vc && a.oc && a.Rc.count() < (0 < a.Gb.length ? 2 : 1)) {
            ...
            b.pw = a.Sd;
            b.ser = a.Bc;
            for (var b = a.Qb(b), c = "", d = 0; 0 < a.Gb.length;)if (1870 >= a.Gb[0].fd.length + 30 + c.length) {
                var e = a.Gb.shift(), c = c + "&seg" + d + "=" + e.ae + "&ts" + d + "=" + e.fe + "&d" + d + "=" + e.fd;
                d++
            } else break;
            Vc(a, b + c, a.Bc);
            return !0
    ...
    function Xc(a, b) {
        var c = Q && Q.isAvailable(), d = c && !(mb.nd || !0 === mb.get("previous_websocket_failure"));
        ...
        return function (c) {
            if (2 != a.na)if (b === a.Lb) {
                ...
                if ("c" == d) {
                    ...
                    a.Oc && (a.Oc(c), a.Oc = null), a.T = null, a.close()) : "r" === d ? (a.e("Reset packet received.  New host: " + c), pb(a.N, c), 1 === a.na ? a.close() : (gd(a), ad(a))) : "e" === d ? Rb("Server Error: " + c) : "o" === d ? (a.e("got pong on primary."), hd(a), id(a)) : Rb("Unknown control packet command: " + d)
                } else"d" == d && a.cc(c)
            } else if (b === a.w)if (d = Xb("t", c), c = Xb("d", c), "c" == d)"t" in c && (c = c.t, "a" === c ? jd(a) : "r" === c ? (a.e("Got a reset on secondary, closing it"), a.w.close(), a.Ob !== a.w && a.Lb !== a.w || a.close()) : "o" === c && (a.e("got pong on secondary."),
                a.wd--, jd(a))); else if ("d" == d)a.fc.push(c); else throw Error("Unknown protocol layer: " + d); else a.e("message on old connection")
        }
    }
    ...
    function jd(a) {
        0 >= a.wd ? (a.e("Secondary connection is healthy."), a.ab = !0, a.w.Lc(), a.w.start(), a.e("sending client ack on secondary"), a.w.send({
            ...
            t: "c",
            d: {t: "n", d: {}}
        }), a.Ob = a.w, fd(a)) : (a.e("sending ping on secondary."), a.w.send({t: "c", d: {t: "p", d: {}}}))
    }
    ...
    function dd(a, b, c) {
        ...
        0 === a.Tc ? (a.e("Primary connection is healthy."), a.ab = !0) : setTimeout(function () {
            id(a)
        }, 5E3)
    }
    ...
    h.mb = function (a, b, c) {
        ...
        b && (this.e("Admin auth credential detected.  Reducing max reconnect time."), this.Xb =
            3E4)
    };
    h.Pb = function (a) {
        delete this.Ka;
        this.zb(!1);
        this.S && this.Ga("unauth", {}, function (b) {
            a(b.s, b.d)
        })
    };
    function sd(a) {
        var b = a.Ka;
        a.S && b && a.Ga("auth", {cred: b.Id}, function (c) {
            var d = c.s;
            c = c.d || "error";
    ...
    function Ad(a, b) {
        var c = a.U[b].action, d = a.U[b].td, e = a.U[b].D;
        a.U[b].Xd = a.S;
        a.Ga(c, d, function (d) {
            a.e(c + " response", d);
            delete a.U[b];
    ...
    h.pd = function () {
        ...
        0 === this.Db && (this.U = []);
        if (this.Ra)this.lb ? this.vb && (3E4 < (new Date).getTime() - this.vb && (this.ua = 1E3), this.vb = null) : (this.e("Window isn't visible.  Delaying reconnect."), this.ua = this.Xb, this.Kc = (new Date).getTime()), a = Math.max(0, this.ua - ((new Date).getTime() - this.Kc)), a *= Math.random(), this.e("Trying to reconnect in " +
            a + "ms"), nd(this, a), this.ua = Math.min(this.Xb, 1.3 * this.ua); else for (var c in this.Kb)delete this.Kb[c];
        this.bc(!1)
    };
    function Cd(a) {
        if (a.Ra) {
            ...
            a.vb = null;
            var b = r(a.cc, a), c = r(a.Bb, a), d = r(a.pd, a), e = a.id + ":" + od++;
    ...
    function Ed(a, b, c) {
        if (b.f())a.F = c, a.o = null; else if (null !== a.F)a.F = a.F.Aa(b, c); else {
            null == a.o && (a.o = new Mc);
            var d = C(b);
    ...
    function Ld(a, b, c) {
        ...
        c.A(function (d) {
            d = d.name();
            var e = a.O(d), f = b.O(d), g = I(c, d), e = Ld(e, f, g);
            a = a.H(d, e)
        });
        return a
    }
    ...
    Qd.prototype.Ib = function () {
        for (var a = 0; a < this.Ya.length; a++)if (this.Ya[a]) {
            var b = this.Ya[a];
            this.Ya[a] = null;
            Sd(b)
        }
    ...
    function Wd(a, b) {
        for (var c = [], d = 0; d < b.length; d++) {
            var e = b[d], f = e.type, g = new E(a.R.m, a.R.path);
            b[d].ca && (g = g.G(b[d].ca));
            g = new P(b[d].wa, g);
    ...
    function $d(a, b, c, d, e) {
        ...
        if (e || g)for (f = c, c = e; null !== f.parent();) {
            ...
            var l = f.parent();
            if (!d.Tb || I(d.Tb, l).j()) {
                var m = b.L(l), p = [], f = Ma(f);
                k.f() ? (k = m.ga(f, e), p.push(new U("child_added", e, f, k))) : e.f() ? p.push(new U("child_removed", k, f)) : (k = m.ga(f, e), g && p.push(new U("child_moved", e, f, k)), c && p.push(new U("child_changed", e, f, k)));
                d.Mc(l, m, p)
            }
            g && (g = !1, c = !0);
            f = l
    ...
    function be(a, b, c, d, e) {
        var f = !1, g = !a.Tb || !I(a.Tb, b).f(), k = [], l = [], m = [], p = [], t = {}, s = {}, w, V, G, H;
        w = c.Za();
        G = Ya(w);
        V = d.Za();
        for (H = Ya(V); null !== G || null !== H;) {
            c = H;
            c = null === G ? 1 : null === c ? -1 : G.key === c.key ? 0 : ic({
                name: G.key,
                ka: G.value.k()
            }, {name: c.key, ka: c.value.k()});
            if (0 > c)f = va(t, G.key), n(f) ? (m.push({
                Fc: G,
                $c: k[f]
            }), k[f] = null) : (s[G.key] = l.length, l.push(G)), f = !0, G = Ya(w); else {
                if (0 < c)f = va(s, H.key), n(f) ? (m.push({
                    Fc: l[f],
                    $c: H
                }), l[f] = null) : (t[H.key] = k.length, k.push(H)), f = !0; else {
                    c = b.G(H.key);
                    if (c = ae(a, c, G.value,
        ...
        for (g = 0; g < m.length; g++)t = m[g].Fc, k = m[g].$c, c = b.G(k.key), l = d.ga(k.key, k.value), e.push(new U("child_moved", k.value, k.key, l)), (c = ae(a, c, t.value, k.value)) &&
        p.push(k);
    ...
    he.prototype.jc = function (a, b) {
        if (null === b)return b;
        var c = [], d = this.R;
        n(d.fa) && (n(d.ya) && null != d.ya ? c.push(function (a, b) {
            var c = Ub(b, d.fa);
            return 0 < c || 0 === c && 0 <= Vb(a, d.ya)
        }) : c.push(function (a, b) {
            return 0 <= Ub(b, d.fa)
        }));
        n(d.Ca) && (n(d.Wa) ? c.push(function (a, b) {
            var c = Ub(b, d.Ca);
        ...
        for (var l = [], m = [], p = [], t = [], s = 0; s < b.length; s++) {
            ...
            switch (b[s].type) {
                ...
                case "child_moved":
                    var G = !this.i.O(w).f(),
                        H = je(c, w, V);
                    G ? H ? (this.i = this.i.H(w, V), p.push(b[s])) : (l.push(new U("child_removed", this.i.O(w), w)), this.i = this.i.H(w, null)) : H && (this.i = this.i.H(w, V), m.push(b[s]))
            }
        }
        var Tc = e || f;
        if (Tc) {
            var Uc = (s = null !== f) ? this.i.hd() : this.i.kd(), hc = !1, $a = !1, ab = this;
        ...
        for (s = 0; s < m.length; s++)c =
            m[s], w = this.i.ga(c.ca, c.wa), l.push(new U("child_added", c.wa, c.ca, w));
    ...
    ke.prototype.Rb = function (a, b, c, d, e) {
        var f = a.path, g = I(this.oa, f), k = g.j();
        null === k ? (k = new ce, J(g, k)) : v(!k.f(), "We shouldn't be storing empty QueryMaps");
        var l = a.Pa();
        if (k.contains(l))a = k.get(l), Ud(a, b, c, d, e); else {
            var m = this.g.$.L(f);
            a = le(a, m);
            me(this, g, k, l, a);
            Ud(a, b, c, d, e);
            (b = (b = Sa(I(this.oa, f), function (a) {
                    var b;
    ...
    function oe(a, b, c, d, e) {
        b = b ? b.Pa() : null;
        var f = [];
        b && "default" !== b ? ne(a, b, c, d, e) && f.push(b) : ub(a.keys(), function (b) {
    ...
    function re(a, b) {
        function c(b) {
            var f = b.j();
            if (f && fe(f))d.push(f.path()), null == f.za && f.setActive(ue(a, f)); else {
                if (f) {
    ...
    function ue(a, b) {
        if (a.u) {
            var c = a.u, d = b.path(), e = b.toString(), f = b.hb(), g, k = b.keys(), l = fe(b);
            pd(a.u, b, function (c) {
                "ok" !== c ? (c = cc(c), L("on() or once() for " + b.path().toString() + " failed: " + c.toString()), ve(a, b, c)) : g || (l ? se(a, b.path(), !0) : ub(k, function (a) {
                    (a = b.get(a)) && Xd(a)
                }), te(a, b.path()))
            });
            return function () {
    ...
    function we(a, b, c, d, e) {
        ...
        $b(b, function (b, m) {
            var p = new F(m);
            3 === b || 1 === b ? g = g.H(m, d.L(p)) : (2 === b && k.push({
                path: f.G(m),
                ta: M
            }), k = k.concat(xe(a, d.L(p), I(c, p), e)))
        });
    ...
    h.dc = function (a, b, c) {
        ...
        var d, e, f = [];
        9 <= a.length && a.lastIndexOf(".priority") === a.length - 9 ? (d = new F(a.substring(0, a.length - 9)), e = S(this.g.va, d).Ia(b), f.push(d)) : c ? (d = new F(a), e = S(this.g.va, d), $b(b, function (a, b) {
            var c = new F(b);
    ...
    h.mb = function (a, b, c) {
        "firebaseio-demo.com" === this.N.domain && L("FirebaseRef.auth() not supported on demo (*.firebaseio-demo.com) Firebases. Please use on production (*.firebaseio.com) Firebases only.");
    ...
    h.kb = function (a, b, c, d) {
        ...
        var e = Ce(this);
        b = O(b, c);
        var e = Pd(b, e), e = ye(this.I, a, e, this.g.M), f = this.g.set(a, e), g = this;
    ...
    h.update = function (a, b, c) {
        ...
        var d = S(this.g.pa, a), e = !0, f = [], g = Ce(this), k = [], l;
        for (l in b) {
            var e = !1, m = O(b[l]), m = Pd(m, g), d = d.H(l, m), p = a.G(l);
            f.push(p);
    ...
    h.Wc = function (a, b, c) {
        ...
        var d = Ce(this), d = Nd(b, d), d = S(this.g.M, a).Ia(d), d = ye(this.I, a, d, this.g.M), e = this.g.set(a, d), f = this;
    ...
    function Ie(a, b, c, d) {
        var e = !0, f;
        for (f in c)e = !1;
        e ? (K("onDisconnect().update() called with empty data.  Don't do anything."), X(d, "ok")) : xd(a.u, b.toString(), c, function (e, f) {
    ...
    h.lc = function (a, b, c, d) {
        if (".info" === C(a.path))this.Jc.lc(a, b, c, d); else {
            b = this.I.lc(a, b, c, d);
            if (c = null !== b) {
                c = this.g;
                d = a.path;
    ...
    function Ke(a, b, c, d, e) {
        ...
        g.fb("value", f);
        c = {
            path: b, update: c, D: d, status: null, qd: Kb(), wc: e, vd: 0, tc: function () {
                g.yb("value", f)
            }, uc: null
        };
    ...
    function Qe(a, b, c) {
        ...
        a.u.put(b.toString(), f, function (e) {
            ...
            if ("ok" === e) {
                ...
                if ("datastale" === e)for (d = 0; d < c.length; d++)c[d].status = 4 === c[d].status ? 5 : 1; else for (L("transaction at " + b + " failed: " + e), d = 0; d < c.length; d++)c[d].status = 5, c[d].uc = e;
                e = De(a, b);
                W(a.I, e, [b])
            }
        }, e)
    ...
    function De(a, b) {
        var c = Se(a, b), d = c.path(), c = Pe(a, c);
        T(a.g.pa, d, S(a.g.M, d));
        T(a.Ha, d, S(a.g.M, d));
        if (0 !== c.length) {
            for (var e = S(a.g.pa, d), f = e, g = [], k = 0; k < c.length; k++) {
                var l = Na(d, c[k].path), m = !1, p;
                v(null !== l, "rerunTransactionsUnderNode_: relativePath should not be null.");
                if (5 === c[k].status)m = !0, p = c[k].uc; else if (1 === c[k].status)if (25 <= c[k].vd)m = !0, p = "maxretry"; else {
                    var t = e.L(l), s = c[k].update(t.V());
                    if (n(s)) {
                ...
                m && (c[k].status = 3, setTimeout(c[k].tc, 0), c[k].D && (m = new E(a, c[k].path), l = new P(e.L(l), m), "nodata" === p ? g.push(r(c[k].D, null, null, !1, l)) : g.push(r(c[k].D, null, Error(p), !1, l))))
            }
            T(a.Ha, d, e);
            T(a.g.pa, d, f);
            Oe(a, a.Sa);
    ...
    function E(a, b) {
        var c, d;
        if (a instanceof ze)c = a, d = b; else {
            ...
            if (q(e)) {
                ...
                if (3 == m.length) {
                    ...
                    if ("firebase" === m[1])Sb(c + " is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"); else for (d = m[0],
            ...
            d = new F(g);
            f = d.toString();
            !(l = !q(c.host) || 0 === c.host.length || !ya(c.Yb)) && (l = 0 !== f.length) && (f && (f = f.replace(/^\/*\.info(\/|$)/, "/")), l = !(q(f) && 0 !== f.length && !xa.test(f)));
            if (l)throw Error(y("new Firebase", 1, !1) + 'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".');
            if (b)if (b instanceof Y)f = b; else throw Error("Expected a valid Firebase.Context for second argument to new Firebase()"); else f = Y.rb();
            l = c.toString();
            e = va(f.ib, l);
    ...
    E.prototype.G = function (a) {
        ...
        if (fa(a))a = String(a); else if (!(a instanceof F))if (null === C(this.path)) {
            var b = a;
            b && (b = b.replace(/^\/*\.info(\/|$)/, "/"));
            Ha("Firebase.child", b)
    ...
    E.prototype.push = function (a, b) {
        ...
        var c = Be(this.m), c = Ve(c), c = this.G(c);
    ...
    function Pb(a, b) {
        ...
        !0 === a ? ("undefined" !== typeof console && ("function" === typeof console.log ? Nb = r(console.log, console) : "object" === typeof console.log && (Nb = function (a) {
            console.log(a)
